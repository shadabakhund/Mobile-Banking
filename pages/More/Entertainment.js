...
<View style={{backgroundColor:"#009591", marginTop: 15}}>
           <Text style={{textAlign:"center", color:"white", fontSize: 25, fontWeight:"bold",}}>HBL Top Deals</Text> 
        </View>
<ScrollView
        horizontal={true}
        showsHorizontalScrollIndicator={false}

          style={{alignSelf: 'center', marginLeft:13 , marginTop: 5,}}>
        <View>
          <View style={{flexDirection: 'row', alignSelf:"center"}}>
          <View style={{paddingRight:13}}>
          <TouchableOpacity style={styles.bigbuttons2}
                 onPress={ ()=> Linking.openURL('https://www.hbl.com/personal/cards/hbl-deals-and-discounts')}>
              
                <Image
                source={require("../../Image/daraz.jpeg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <Image
                source={require("../../Image/LDaraz.jpg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
            ...
            />
            <Text style={{textAlign:'center', marginTop: 0, color:'#fff',  fontWeight:'bold', fontSize:18, paddingLeft: 6,}}>
              Daraz Discounts</Text></View>
                </TouchableOpacity>
            </View>
            <View style={{paddingRight:13}}>
          <TouchableOpacity style={styles.bigbuttons2}
                ...
                <Image
                source={require("../../Image/foodpanda.jpeg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <View style={{flexDirection: 'row', alignItems:"center", alignSelf: 'center',}}>
            <Image
                source={require("../../Image/Lfoodpanda.jpeg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
          ...
          <TouchableOpacity style={styles.bigbuttons2}
                ...
                <Image
                source={require("../../Image/dvago.jpeg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <View style={{flexDirection: 'row', alignItems:"center", alignSelf: 'center',}}>
            <Image
                source={require("../../Image/LDvago.jpeg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
          ...
          <TouchableOpacity style={styles.bigbuttons2}
                ...
                <Image
                source={require("../../Image/agakhan.jpg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <View style={{flexDirection: 'row', alignItems:"center", alignSelf: 'center',}}>
            <Image
                source={require("../../Image/LAgakhan.jpeg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
          ...
          <TouchableOpacity style={styles.bigbuttons2}
                ...
                <Image
                source={require("../../Image/dunkin.jpeg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <View style={{flexDirection: 'row', alignItems:"center", alignSelf: 'center',}}>
            <Image
                source={require("../../Image/LDunkin.jpeg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
          ...
          <TouchableOpacity style={styles.bigbuttons2}
                ...
                <Image
                source={require("../../Image/pizzahut.jpeg")}    
                style={{
                    width:280,
                    height:85,
                    resizeMode:"center",
            ...
            <View style={{flexDirection: 'row', alignItems:"center", alignSelf: 'center',}}>
            <Image
                source={require("../../Image/Lpizzahut.jpeg")}    
                style={{
                    width:20,
                    height:25,
                    resizeMode:"center",
